...
//Funktio tietoja hakemista varten. Kutsutaan backin GET-metodia ja välitetään hakusana. Jos ei hakusanaa, niin tuodaan kaikki tiedot.
//GET /asiakkaat/haemonta/hakusana
function haeTiedot(){	
	$("#listaus tbody").empty();
	$.ajax({url:"asiakkaat/haemonta/"+$("#hakusana").val(), type:"GET", dataType:"json", success:function(result){//Funktio palauttaa tiedot json-objektina		
...
//Funktio tietojen muuttamista varten. Kutsutaan backin DELETE-metodia ja välitetään poistettavan tiedon id. 
//DELETE /asiakkaat/id
